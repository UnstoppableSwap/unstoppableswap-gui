    ...
    <InfoBox
      ...
      mainContent={
        <Typography variant="subtitle2">
          ...
          volunteers. You can start and stop Tor by clicking the buttons below.
          If Tor is running, all traffic will be routed through it and the swap
          provider will not be able to see your IP address.
        </Typography>
      }
      additionalContent={
